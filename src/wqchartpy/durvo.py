    ...
    for i, x in enumerate(np.linspace(0, -0.618, 8)):
        ...
        if i in [2, 4, 6]:
            ax.text(-2 * ticklength, x, round(pHlabels[i], 2), 
                    ha='right', va='center')
    ax.text(-0.25, -0.618 / 2, 'pH', rotation=90, 
             ha='center', va='center', fontsize=12)
